...
Exercise 6
 ...
 Think about how you'd loop through the `gyms` array to check and update the `completed` property.
...
for (let i= 0; i < game.party.length; i++){
  const currentPokemon = game.party[i];
  const currentPokemonNumber = currentPokemon.number;
  const nextPokemonNumber = currentPokemonNumber + 1;
  game.party[i] = pokemon[nextPokemonNumber - 1]
} 

console.log("Exercide 7")
console.log(game.party)
...
*/
 ...
 game.catchPokemoncatchPokemon = function(pokemonObj){
  game.party.push(pokemonObj);  
...
game.gymStatus = function(){
  ...
  console.log("gym tally: " + JSON.stringify(gymTally))
}
